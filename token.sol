...
contract PokaAI is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxWallet = payable(0xA0a7d51451B135E3938A7517682584fC485b9DF8);


    uint256 public _buyTax = 5; //Buy fee
    uint256 public _sellTax = 15; // sell fee


    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 100000000 * 10**_decimals; // Total supply
    string private constant _name = unicode"PokaAI";  // Name
    string private constant _symbol = unicode"PokaAi"; // Symbol
